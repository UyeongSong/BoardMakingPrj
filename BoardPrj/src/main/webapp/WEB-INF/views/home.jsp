...
<jsp:include page="/WEB-INF/views/include/bodyHeader.jsp"/>
	...
	<div class="alert alert-warning" class="page-header">
		<h3><fmt:message key="WELECOM_MESSAGE"/></h3>
	</div>
			<div class="row">
				...
				<div class="col-xs-12 col-sm-6 col-md-4 col-lg-4">Curabitur 
					...
					consectetur adipscing elit. Vivamus mattis a mauris.</div>
			...
			<div class="progress">
				<div class="progress-bar porgress-bar-danger" role="progressbar" aria-valuenow="100" aria-valuemin="0" aria-valuemax="100" style="width:100%;">
				<span class="sr-only"></span>
				</div>
			</div>
			<div class="progress">
				<div class="progress-bar porgress-bar-warning" role="progressbar" aria-valuenow="100" aria-valuemin="0" aria-valuemax="100" style="width:100%;">
				<span class="sr-only"></span>
				</div>
			</div>
