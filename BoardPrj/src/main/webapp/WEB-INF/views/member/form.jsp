	...
	<div class="content">
		<form action="<c:url value='/member/insert.do'/>" method="post" id="joinForm" class="form-horizontal">
			<div class="form-group">
				...
				<div class="col-sm-4">
				<input type="text" name="userid" id="userid" value="${member]['userid']}" ${empty member.userid ? "" : "readonly"} title="<fmt:message key='USERID_TITLE'/>" pattern="\w+" class="form-control" placeholder="<fmt:messager key="MEMBER_ID"/>" required>
				</div>
			</div>	
			<div class="form-group">	
